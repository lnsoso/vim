...
"Enable syntax hl
syntax enable
"set fileencodings=utf-8,big5,euc-jp,gbk,euc-kr,utf-bom,cp936
let &termencoding=&encoding 
set encoding=utf-8
set fencs=utf-8,gbk,gb2312,big5,euc-jp,utf-16le
set fenc=utf-8 enc=utf-8 tenc=utf-8
set dictionary-=~/.vim/dict/php.txt dictionary+=~/.vim/dict/php.txt
...
if MySys() == "mac"
  ...
  "set guifont=TextMate_Regular:h13:cANSI
...
au FileType html,python,vim,javascript,php,java,python,py,ruby,rb setl shiftwidth=4
au FileType html,python,vim,javascript,php,java,python,py,ruby,rb setl tabstop=4
